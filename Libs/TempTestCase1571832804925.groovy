...
RunConfiguration.setExecutionSettingFile('C:\\Users\\DANIEL~1.DON\\AppData\\Local\\Temp\\Katalon\\Test Cases\\SD FLOW Advance Pay\\SD FLOW PO\\20191023_151324\\execution.properties')
...
WebUI.setText(findTestObject('PO_SD/input_Invoice_Number'), String.valueOf(Math.abs(new Random().nextInt() % 9999) + 1))
