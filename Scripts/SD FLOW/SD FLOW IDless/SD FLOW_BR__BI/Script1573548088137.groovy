...
WebUI.navigateToUrl('http://web7.egt-bg.ro:7955/?#!/sales_department/billing')
...
CustomKeywords.'linkers.Link_SD_FLOW_IDless.billing_request'()
...
WebUI.setText(findTestObject('BI/input_Payment Due Date (first month)'), dateNow, FailureHandling.CONTINUE_ON_FAILURE)
